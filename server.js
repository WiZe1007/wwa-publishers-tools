...
1. Відкриття: 1–2 короткі речення від другої особи ("You", "Your") — сцена або ситуація гравця, БЕЗ фрази-хука типу "Discover/Welcome/Enter". Назву додатку не став першим словом речення, але згадай її в межах цього відкриття (наприклад, у другій частині речення або в другому реченні).
1a. НАЗВА ДОДАТКУ: точна назва має зустрічатися в повному описі 1–3 рази (обов'язково хоча б один раз у першому абзаці, в межах перших 167 символів). Не більше 3 разів — далі використовуй "the game", "the app", "it". Назву пиши точно так, як вона задана, без змін.
